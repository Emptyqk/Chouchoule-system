...
public:
    ...
    void setupUi(QWidget *Addgam)
    {
        ...
        totalcapacityinput = new QLineEdit(widget);
        totalcapacityinput->setObjectName("totalcapacityinput");

        verticalLayout->addWidget(totalcapacityinput);
    ...
    void retranslateUi(QWidget *Addgam)
    {
        ...
        totalcapacityinput->setPlaceholderText(QCoreApplication::translate("Addgam", "\350\257\267\350\276\223\345\205\245\345\256\271\351\207\217", nullptr));
