...
#include "../../../../CCL snzljw/changeuser.h"
...
static constexpr auto qt_meta_stringdata_CLASSChangeuserENDCLASS = QtMocHelpers::stringData(
    "Changeuser",
    "userChanged",
    "",
    "on_change_clicked"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSChangeuserENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSChangeuserENDCLASS_t qt_meta_stringdata_CLASSChangeuserENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10),  // "Changeuser"
        QT_MOC_LITERAL(11, 11),  // "userChanged"
        QT_MOC_LITERAL(23, 0),  // ""
        QT_MOC_LITERAL(24, 17)   // "on_change_clicked"
    },
    "Changeuser",
    "userChanged",
    "",
...
void Changeuser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Changeuser::userChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
