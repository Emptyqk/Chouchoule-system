...
Q_CONSTINIT static const qt_meta_stringdata_CLASSNoteENDCLASS_t qt_meta_stringdata_CLASSNoteENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(5, 6),  // "inmenu"
        QT_MOC_LITERAL(12, 0),  // ""
        QT_MOC_LITERAL(13, 17)   // "on_tomenu_clicked"
    },
    "Note",
    "inmenu",
    "",
...
void Note::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Note::*)();
            if (_t _q_method = &Note::inmenu; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
